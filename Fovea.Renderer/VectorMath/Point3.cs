...
{
    /// <summary>in contrast to the books, also have a dedicated point3 class</summary>
    public readonly struct Point3 : IEquatable<Point3>
    {
        ...
        {
            return new(p.PX + v.X, p.PY + v.Y, p.PZ + v.Z);
        }
        ...
        {
            return new(left.PX - right.PX, left.PY - right.PY, left.PZ - right.PZ);
        }
        ...
        {
            return new(p.PX * scalar, p.PY * scalar, p.PZ * scalar);
        }
        ...
        {
            return HashCode.Combine(PX, PY, PZ);
        }
